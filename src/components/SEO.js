...
const SEO = ({
  title = "Kalion.Digital - Розробка цифрових продуктів",
  ...
  image = "https://kalion.digital/logo_w.svg",
  url = "https://kalion.digital/",
  keywords = "AI автоматизація, SaaS розробка, чат-боти, веб-розробка, розробка ігор, IT консалтинг, цифрові продукти"
}) => {
  return (
    <Helmet>
      {/* Primary Meta Tags */}
